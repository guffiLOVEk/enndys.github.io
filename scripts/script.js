...
document.addEventListener('DOMContentLoaded', function () {
    ...
    navMenu.forEach(item => {
        item.addEventListener('click', (event) => {
            ...
            if(item == navMenu1) {
                ...
                if(document.querySelector('.menu__ul.tab-2').classList.contains('active')) {
                    document.querySelector('.menu__ul.tab-2').classList.remove('active')
                }
                if(document.querySelector('.menu__ul.tab-3').classList.contains('active')) {
                    document.querySelector('.menu__ul.tab-3').classList.remove('active')
                }
            }
            if(item == navMenu2) {
                item.querySelector('.menu__ul.tab-2').classList.toggle('active')
                if(document.querySelector('.menu__ul.tab-1').classList.contains('active')) {
                    document.querySelector('.menu__ul.tab-1').classList.remove('active')
                }
                if(document.querySelector('.menu__ul.tab-3').classList.contains('active')) {
                    document.querySelector('.menu__ul.tab-3').classList.remove('active')
                }
    ...
    let loginBlock = document.querySelector('.login__block')
    let loginActive = document.querySelectorAll('.login__active')
